...
INSERT INTO `perro` (`nombre`, `id_raza`, `edad`, `estado`, `costo_apadrinar`) VALUES
('Tony', 12, 2, 'muerto', 100000);
...
--
ALTER TABLE `apadrinar`
  MODIFY `id_padrino` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `formularioapadrinar`
  MODIFY `id_apadrinar` int(11) NOT NULL AUTO_INCREMENT;
