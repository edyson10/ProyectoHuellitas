...
<div class="wrapper">
  ...
  <!-- 	CONTENIDO DE LA PAGINA AGREGAR PADRINO START -->
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Registro Apadrinamiento</h3>
            </div>
            <form role="form" action="ApadrinarController" method="post">
              <div class="box-body">
                ...
                <jsp:useBean id="cDao" class="model.PersonaDAO" scope="request"></jsp:useBean>
                <div class="form-group">
                  <label for="exampleInputPassword1">Cédula de la persona</label>
                  <select id="persona" name="persona" class="form-control select2" style="width: 100%;">
                    <c:forEach var="personas" items="${cDao.list()}">
							<option value="${personas.cedula}">${personas.cedula}</option>
						</c:forEach>
                  </select>
                </div>
                ...
                <div class="box-footer">
	                <div class="form-group">
	                  ...
	                  <input type="date" name="fechaInicioPad" class="form-control" placeholder="Ciudad de residencia">
	                </div>
                  	<button type="submit" class="btn btn-primary">Agregar apadrinación</button>
                </div>
              </div>
            </form>
          </div>
  ...
  <!-- 	CONTENIDO DE LA PAGINA AGREGAR PADRINO END -->
