...
<div class="wrapper">
  ...
  <!-- 	CONTENIDO DE LA PAGINA REGISTRAR TRATAMIENTO START -->
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Registro de Tratamiento</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="TratamientoController">
              <div class="box-body">
                ...
                <jsp:useBean id="eDao" class="model.EnfermedadDAO" scope="request"></jsp:useBean>
                <div class="form-group">
                  <label for="exampleInputPassword1">Enfermedades</label>
                  <select id="enfermedad" name="enfermedad" class="form-control select2" style="width: 100%;">
                    <c:forEach var="enfermedades" items="${eDao.list()}">
							<option value="${enfermedades.idEnfermedad}">${enfermedades.nombreEnfermedad}</option>
						</c:forEach>
                  </select>
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Descripción del tratamiento</label>
                  <input type="text" name="descripcion" class="form-control" id="exampleInputPassword1" placeholder="Descripción del tratamiento del perro" required>
                </div>
                
                <div class="form-group">
                	<label for="exampleInputPassword1">Fecha inicio tratamiento</label>
	            	<input type="date" name="fechaInicioTrat" class="form-control" required>
	            </div>
	               
                <div class="form-group">
                  	<label for="exampleInputPassword1">Fecha fin tratamiento (Solo si ya termino)</label>
                 	 <input type="date" name="fechaFinTrat" class="form-control">
                </div>
  ...
  <!-- 	CONTENIDO DE LA PAGINA REGISTRAR TRATAMIENTO END -->

	<footer class="main-footer">
    	<div class="pull-right hidden-xs">
      		<b>Version</b> 1.0.0
    	</div>
    	<strong>Copyright &copy; 2019 <a href="https://google.com" target="_blank">Huellitas</a>.</strong> All rights reserved.
  	</footer>
