...
<div class="wrapper">
  ...
  <!-- CONTENIDO DE LA PAGINA BUSCAR PADRINO START -->
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Busqueda de Padrino</h3>
            </div>
            <form role="form" method="post" action="RazaController">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Cedula persona</label>
                  <input type="text" class="form-control" name="cPersona" placeholder="" required>
                </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Registro Padrino</h3>
            </div>
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" readonly="readonly" class="form-control" id="ejemploImputNombre" placeholder="">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Ciudad</label>
                  <input type="text" readonly="readonly" class="form-control" placeholder="">
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre</label>
                  <input type="text" class="form-control" id="ejemploImputNombre" placeholder=" ">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="ejemploImputNombre" placeholder="dd/mm/aaaa">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="ejemplo@gmail.com">
                </div>
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">¿Qué te motivó a apadrinar?</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder=" ">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">¿Te gustaría apadrinar más de un perro?</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder=" ">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">¿Ya has apadrinado a un perro antes?</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder=" ">
                </div>
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">¿Sabes la responsabilidad de apadrinar?</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder=" ">
                </div>
        ...
        <!--Fin Formulario Adopción--->
      </div>
    </section>
  </div>
  <!-- CONTENIDO DE LA PAGINA BUSCAR PADRINO END -->
