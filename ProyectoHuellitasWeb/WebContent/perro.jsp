        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Registro Perrito</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="PerroController" method="post">
              <div class="box-body">

                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre</label>
                  <!--<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">-->
                  <input type="text" name="nombre" class="form-control" id="ejemploImputNombre" placeholder="Nombre del perro">
                </div>
                
                <jsp:useBean id="rDao" class="model.RazaDAO" scope="request"></jsp:useBean>
	          	<div class="form-group">
		            <div class="form-label-group">
		              <label for="estado">Raza</label>
		              <select id="raza" name="raza" class="form-control">
		              	<c:forEach var="razas" items="${rDao.list()}">
							<option value="${razas.idRaza}">${razas.nombreRaza}</option>
						</c:forEach>
					  </select>
		            </div>
	      		</div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="edad" class="form-control" id="exampleInputPassword1" placeholder="edad">
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Estado</label>
                  <input type="text" name="estado" class="form-control" id="exampleInputPassword1" placeholder="estado físico del perro">
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Costo de Apadrinamiento</label>
                  <input type="text" name="costo" class="form-control" id="exampleInputPassword1" placeholder="costo">
                </div>
                
                <div class="form-group">
                  <label for="exampleInputFile">Foto</label>
                  <input type="file" id="exampleInputFile">
                  <p class="help-block">Añade una imagen de perfil.</p>
                </div>
