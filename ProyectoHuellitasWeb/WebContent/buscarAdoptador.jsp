...
<div class="wrapper">
  ...
  <!-- CONTENIDO DE LA PAGINA BUSCADOR ADOPTADOR START -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <!--------------------------
            Busqueda de Adoptador
        --------------------------->
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Busqueda de Adoptador</h3>
            </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Visualizar Adoptador</h3>
            </div>
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" readonly="readonly" class="form-control" placeholder="Fecha Actual">
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Ciudad</label>
                  <input type="text" readonly="readonly" class="form-control" placeholder="Ciudad de residencia">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" readonly="readonly" class="form-control" placeholder="edad">
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha de Nacimiento</label>
                  <input type="text" readonly="readonly" class="form-control" placeholder="dd/mm/aaaa">
                </div>
  ...
  <!-- CONTENIDO DE LA PAGINA BUSCADOR ADOPTADOR END -->
