        ...
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Registro adoptador</h3>
            </div>
            <form role="form" action="AdopcionController" method="post">
              <div class="box-body">
                ...
                <div class="box-footer">
                	<div class="form-group">
                  		...
                  		<input type="date" name="fechaInicioAdop" class="form-control" placeholder="Ciudad de residencia">
                	</div>
