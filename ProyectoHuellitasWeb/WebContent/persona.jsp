      ...
      <div class="row"> 
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="PersonaController" method="post">
              <div class="box-body">

                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre</label>
                  <!--<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">-->
                  <input type="text" name="nombre" class="form-control" id="ejemploImputNombre" placeholder="Escriba el nombre" required>
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Apellido</label>
                  <input type="text" name="apellido" class="form-control" id="exampleInputPassword1" placeholder="Escriba el apellido" required>
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Cédula</label>
                  <input type="text" name="cedula" class="form-control" id="exampleInputPassword1" placeholder="Escriba la cédula" required>
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Fecha nacimiento</label>
                  <input type="date" name="fechanacimiento" class="form-control" id="exampleInputPassword1" placeholder="" required>
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Dirección</label>
                  <input type="text" name="direccion" class="form-control" id="exampleInputPassword1" placeholder="Direccion de residencia" required>
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">Teléfono</label>
                  <input type="text" name="telefono" class="form-control" id="exampleInputPassword1" placeholder="Celular o teléfono" required>
                </div>
                
              	<jsp:useBean id="cDao" class="model.CiudadDAO" scope="request"></jsp:useBean>
	          	<div class="form-group">
		            <div class="form-label-group">
		              <label for="estado">Ciudad residencia</label>
